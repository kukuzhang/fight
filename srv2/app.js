...
var server = app.listen(8889, '127.0.0.1');
...
ws.on('connection', function(client){
    ...
    client.on('send.message', function(msg){
        console.log(client.nickname+' msg on send.mssage :'+JSON.stringify(msg));
        client.broadcast.emit('send.message',client.nickname,  msg);
    });

    client.on('send.move',function (msg) {
        console.log(client.nickname+' msg on my.move :'+JSON.stringify(msg));
        client.broadcast.emit('send.message',client.nickname,  msg);
        client.emit('news', msg);
    });
